...
echo '<item icon="/home/john/.config/openbox/square-open.png" label="Steam"><action name="Execute"><execute>steam</execute></action></item>'
echo '<separator/>'
...
echo "<item icon=\"/home/john/.config/openbox/square-open.png\" label=\"$NAME\"><action name=\"Execute\"><execute>steam steam://run/$ID</execute></action></item>"
done
echo '</openbox_pipe_menu>'
