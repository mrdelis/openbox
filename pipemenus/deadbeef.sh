...
playlist_dir=`/home/john/.config/deadbeef/playlists/`
playlist_num=`ls -l /home/john/.config/deadbeef/playlists/* | wc -l | sed -n '1p'`
...
for file in $(ls /home/john/.config/deadbeef/playlists/*.dbpl -1v); do
